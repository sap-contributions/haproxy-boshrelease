...
AWS_LC_VERSION=5.8.0  # https://github.com/aws/aws-lc/archive/refs/tags/v5.8.0.tar.gz
AWS_LC_FIPS_VERSION=4.0.0  # https://github.com/aws/aws-lc/archive/refs/tags/v4.0.0.tar.gz
